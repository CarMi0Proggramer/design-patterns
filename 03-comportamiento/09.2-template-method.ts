...
class HotelRoomCleaning extends RoomCleaning {
  protected override specificCleaning(): void {
    console.log(
      chalk.bold.green("Haciendo las camas y reponiendo artículos de baño.")
    );
  }
}
...
class ConferenceRoomCleaning extends RoomCleaning {
  protected override specificCleaning(): void {
    console.log(chalk.bold.green("Limpiando mesas y organizando sillas."));
  }
}
...
class OfficeCleaning extends RoomCleaning {
  protected override specificCleaning(): void {
    console.log(
      chalk.bold.green("Limpiando escritorios y organizando documentos.")
    );
  }
}
